...
<head>
  ...
  <title>ReliefConnect – Volunteer Login</title>
...
<main class="flex-1 flex items-start justify-center py-12 px-4">
  <div class="w-full max-w-md bg-white rounded-2xl shadow-lg overflow-hidden">
    ...
    <!-- Card Header – indigo/blue gradient matching screenshot -->
    ...
    <div class="px-7 py-6">
      ...
      <div class="flex gap-1 bg-gray-100 rounded-xl p-1 mb-6">
        ...
        <button class="tab-btn inactive" onclick="window.location='volunteer_register.php'">Register</button>
      </div>
