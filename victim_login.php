...
<head>
  ...
  <title>Affected Person Login - ReliefConnect</title>
...
<body class="text-gray-900" style="background:#eef4f8; min-height:100vh;">
  ...
  <main class="py-12 px-4 flex justify-center">
    <div class="w-full max-w-md">
      ...
      <!-- Affected Person Role Banner -->
      <div class="rounded-t-2xl overflow-hidden" style="background:linear-gradient(135deg,#475569 0%,#334155 100%);">
        <div class="px-6 pt-6 pb-5">
          <div class="flex items-center gap-3 mb-3">
            <div class="w-12 h-12 rounded-xl bg-white bg-opacity-15 flex items-center justify-center flex-shrink-0">
              <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
              </svg>
            </div>
            <div>
              <div class="text-white font-black text-xl leading-tight">Affected Person</div>
              <div class="text-slate-300 text-xs">Request help and view relief status</div>
            </div>
          </div>
          <a href="role_page.php" class="text-slate-300 text-xs hover:text-white flex items-center gap-1">
      ...
      <div class="bg-white rounded-b-2xl shadow-lg px-7 pt-6 pb-7">
        ...
        <div class="flex rounded-xl overflow-hidden border border-gray-200 mb-6">
          ...
          <a href="victim_register.php" class="flex-1 py-2.5 text-sm font-semibold text-gray-500 bg-gray-50 hover:bg-gray-100 border-l border-gray-200 transition-colors text-center">Register</a>
        </div>
        ...
        <div class="mb-3">
          ...
          <div class="relative">
            ...
            <input type="password" id="login-password" placeholder="Enter your password" class="w-full border border-gray-200 rounded-lg pl-9 pr-10 py-2.5 text-sm text-gray-700 placeholder-gray-400 transition-all" />
            <button onclick="togglePwd('login-password')" class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600">
        ...
        <div class="flex items-center justify-between mb-6">
          <label class="flex items-center gap-2 cursor-pointer">
            <input type="checkbox" class="w-3.5 h-3.5 rounded border-gray-300 accent-cyan-500" />
            <span class="text-xs text-gray-600">Remember me</span>
          </label>
          <a href="#" class="text-xs font-semibold hover:underline" style="color:#00BFFF">Forgot password?</a>
        </div>
