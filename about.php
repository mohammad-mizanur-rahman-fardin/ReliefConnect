  ...
  <nav class="bg-black text-white px-6 py-3 flex items-center justify-between sticky top-0 z-50">
    <div class="flex items-center gap-8">
      ...
      <ul class="hidden md:flex gap-6 text-sm text-gray-300">
        ...
        <li><a href="about.php" class="hover:text-white text-white underline-offset-8 underline">About</a></li>
  ...
  <section class="py-16 px-6 bg-white text-center">
    <div class="max-w-2xl mx-auto">
      ...
      <div class="flex justify-center gap-4 flex-wrap">
        <a href="#" class="text-white text-sm font-semibold px-6 py-2.5 rounded-md hover:opacity-90" style="background:#00BFFF">Get Started Today</a>
        <a href="#" class="border border-gray-300 text-gray-800 text-sm font-semibold px-6 py-2.5 rounded-md hover:bg-gray-50">View Campaigns</a>
      </div>
    </div>
  </section>
