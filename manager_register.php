...
<head>
  ...
  <title>ReliefConnect – Camp Manager Register</title>
  ...
  <div class="w-full max-w-md bg-white rounded-2xl shadow-lg overflow-hidden">
    ...
    <div class="px-7 py-6">
      ...
      <div class="flex gap-1 bg-gray-100 rounded-xl p-1 mb-6">
        <button class="tab-btn inactive" onclick="window.location='manager_login.php'">Login</button>
      ...
      <div style="background:#e0f7ff; border:1px solid #bae6fd;" class="rounded-xl px-4 py-3 mb-5">
        <p class="text-sm" style="color:#0369a1;">
          <span class="font-bold">Note:</span> Camp Manager accounts require admin approval before activation.
        </p>
      </div>
