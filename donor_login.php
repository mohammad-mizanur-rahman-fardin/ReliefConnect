...
<head>
  ...
  <title>Donor Login - ReliefConnect</title>
    ...
    <div class="w-full max-w-md">
      ...
      <div class="bg-white rounded-b-2xl shadow-lg px-7 pt-6 pb-7">
        ...
        <div class="flex rounded-xl overflow-hidden border border-gray-200 mb-6">
          ...
          <button onclick="goToRegister()" class="flex-1 py-2.5 text-sm font-semibold text-gray-500 bg-gray-50 hover:bg-gray-100 border-l border-gray-200 transition-colors">Register</button>
        </div>
