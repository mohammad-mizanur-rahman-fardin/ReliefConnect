...
<head>
  ...
  <title>Affected Person Register - ReliefConnect</title>
    ...
    <div class="w-full max-w-md">
      ...
      <div class="bg-white rounded-b-2xl shadow-lg px-7 pt-6 pb-7">
        ...
        <div class="flex rounded-xl overflow-hidden border border-gray-200 mb-6">
          <a href="victim_login.php" class="flex-1 py-2.5 text-sm font-semibold text-gray-500 bg-gray-50 hover:bg-gray-100 transition-colors text-center">Login</a>
        ...
        <button class="w-full text-white text-sm font-bold py-3 rounded-lg hover:opacity-90 transition-opacity mb-4" style="background:#00BFFF">
          Create Account
        </button>
        ...
        <div class="rounded-lg px-4 py-3 mb-5" style="background:#eff9ff; border:1px solid #bae6fd;">
          <p class="text-xs leading-relaxed" style="color:#0284c7;">
            <span class="font-bold">Note:</span> Affected Person accounts require admin approval before activation.
          </p>
        </div>
