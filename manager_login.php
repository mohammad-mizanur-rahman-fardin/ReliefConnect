...
<head>
  ...
  <title>ReliefConnect – Camp Manager Login</title>
...
<main class="flex-1 flex items-start justify-center py-12 px-4">
  <div class="w-full max-w-md bg-white rounded-2xl shadow-lg overflow-hidden">
    ...
    <!-- Card Header -->
    <div style="background:#00BFFF;" class="px-7 pt-7 pb-6">
      <div class="flex items-center gap-4 mb-4">
        ...
        <div>
          <h2 class="text-xl font-bold text-white">Camp Manager</h2>
          <p class="text-sm text-white/80">Manage relief camps and volunteers</p>
        </div>
      </div>
      <a href="role_page.php" class="text-sm text-white/90 hover:text-white underline-offset-2 hover:underline">← Change Role</a>
    </div>
    ...
    <div class="px-7 py-6">
      ...
      <div class="flex gap-1 bg-gray-100 rounded-xl p-1 mb-6">
        ...
        <button class="tab-btn inactive" onclick="window.location='manager_register.php'">Register</button>
      </div>
      ...
      <div class="flex items-center justify-between mb-6">
        <label class="flex items-center gap-2 text-sm text-gray-600 cursor-pointer select-none">
          <input type="checkbox" class="w-4 h-4 rounded border-gray-300 accent-[#00BFFF]"/>
          Remember me
        </label>
        <a href="#" style="color:#00BFFF;" class="text-sm font-semibold hover:underline">Forgot password?</a>
      </div>
