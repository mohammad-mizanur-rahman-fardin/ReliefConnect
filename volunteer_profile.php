    ...
    <div class="w-[100%]">
        ...
        <header class="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
          <div class="flex items-center gap-3">
            <div>
              <h1 class="text-lg font-bold text-gray-900 leading-tight">Volunteer Profile</h1>
        ...
        <main class="max-w-5xl mx-auto py-8 px-6">
          <div class="flex gap-6 items-start">
            ...
            <!-- LEFT PROFILE CARD -->
            <aside class="bg-white rounded-xl border border-slate-200 shadow-md h-[480px] p-6">
              <div class="flex flex-col items-center">
                <div class="relative">
                  <div class="w-[112px] h-[112px] rounded-full bg-blue-600 shadow-xl flex items-center justify-center">
                  ...
                  <button class="absolute right-0 bottom-1 w-8 h-8 rounded-full bg-[#0ea5e9] text-white flex items-center justify-center shadow-md">
                ...
                <h2 class="mt-5 text-[22px] font-extrabold leading-6">John Volunteer</h2>
                <p class="text-[#1687ff] font-bold text-[14px] mt-1">Active Volunteer</p>
                <p class="text-slate-500 text-[13px] mt-3">First Aid, Distribution, Registration Support</p>
              </div>

              <hr class="my-5 border-slate-200" />

              <div class="space-y-3 text-[13px] text-slate-600 px-1">
                <p class="flex items-center gap-3">
                  <span>✉</span> john.volunteer@email.com
                </p>
                <p class="flex items-center gap-3">
                  <span>⌕</span> +1 555-HELP-123
                </p>
                <p class="flex items-center gap-3">
                  <span>◎</span> Relief Camp - Sector A
                </p>
              </div>
              ...
              <div class="grid grid-cols-3 text-center">
                <div>
                  <p class="text-[24px] font-extrabold">24</p>
                  <p class="text-[11px] text-slate-500">Tasks</p>
                </div>
                <div>
                  <p class="text-[24px] font-extrabold">180</p>
                  <p class="text-[11px] text-slate-500">Hours</p>
                </div>
                <div>
                  <p class="text-[24px] font-extrabold">5</p>
                  <p class="text-[11px] text-slate-500">Camps</p>
                </div>
              </div>
            </aside>
              ...
              <div class="bg-white border border-gray-200 rounded-2xl shadow-sm p-6">
                ...
                <div id="pinfo-view">
                  <div class="grid grid-cols-2 gap-4 mb-4">
                    <div><p class="text-xs font-semibold text-gray-500 mb-1.5">First Name</p><div class="field-box">John</div></div>
                    <div><p class="text-xs font-semibold text-gray-500 mb-1.5">Last Name</p><div class="field-box">Volunteer</div></div>
                  </div>
                  <div class="grid grid-cols-2 gap-4 mb-4">
                    <div><p class="text-xs font-semibold text-gray-500 mb-1.5">Email Address</p><div class="field-box">john.volunteer@email.com</div></div>
                    <div><p class="text-xs font-semibold text-gray-500 mb-1.5">Phone Number</p><div class="field-box">+1 555-HELP-123</div></div>
                  </div>
                  <div class="grid grid-cols-2 gap-4 mb-4">
                    <div><p class="text-xs font-semibold text-gray-500 mb-1.5">Role</p><div class="field-box">Active Volunteer</div></div>
                    <div><p class="text-xs font-semibold text-gray-500 mb-1.5">Skill</p><div class="field-box">First Aid, Distribution, Registration Support</div></div>
                  </div>
                  <div class="mb-4"><p class="text-xs font-semibold text-gray-500 mb-1.5">Location</p><div class="field-box">Relief Camp - Sector A</div></div>
                  <div><p class="text-xs font-semibold text-gray-500 mb-1.5">Bio</p>
                    <div class="field-box" style="min-height:72px;line-height:1.6;">Passionate about helping communities in need. Available weekdays and weekends for relief operations.</div>
                  </div>
                </div>
                ...
                <div id="pinfo-edit" class="d-none">
                  <div class="grid grid-cols-2 gap-4 mb-4">
                    <div><label class="text-xs font-semibold text-gray-500 mb-1.5 block">First Name</label><input class="field-input" type="text" value="John"/></div>
                    <div><label class="text-xs font-semibold text-gray-500 mb-1.5 block">Last Name</label><input class="field-input" type="text" value="Volunteer"/></div>
                  </div>
                  <div class="grid grid-cols-2 gap-4 mb-4">
                    <div><label class="text-xs font-semibold text-gray-500 mb-1.5 block">Email Address</label><input class="field-input" type="email" value="john.volunteer@email.com"/></div>
                  ...
                  <div class="grid grid-cols-2 gap-4 mb-4">
                    <div><label class="text-xs font-semibold text-gray-500 mb-1.5 block">Role</label><input class="field-input" type="text" value="Active Volunteer"/></div>
                    <div><label class="text-xs font-semibold text-gray-500 mb-1.5 block">Skill</label><input class="field-input" type="text" value="First Aid, Distribution, Registration Support"/></div>
                  </div>
                  <div class="mb-4"><label class="text-xs font-semibold text-gray-500 mb-1.5 block">Location</label><input class="field-input" type="text" value="Relief Camp - Sector A"/></div>
                  <div><label class="text-xs font-semibold text-gray-500 mb-1.5 block">Bio</label><textarea class="field-input">Passionate about helping communities in need. Available weekdays and weekends for relief operations.</textarea></div>
                </div>
              </div>
